...
=======
with open('/home/neuroplex/data/vrd/json_dataset/annotations_train.json', 'r') as f:
    train_file = json.load(f)

with open('/home/neuroplex/data/vrd/json_dataset/objects.json', 'r') as f:
    objects = json.load(f)

with open('/home/neuroplex/data/vrd/json_dataset/predicates.json', 'r') as f:
>>>>>>> v2
...
<<<<<<< HEAD
        ...
        classes.append(name)
=======
        name = objects[sub_pred_obj['object']['category']].replace('motorcycle','motorbike')
        classes.append(name.replace('motorcycle','motorbike'))
>>>>>>> v2
...
<<<<<<< HEAD
        ...
        classes.append(name)
=======
        name = objects[sub_pred_obj['subject']['category']].replace('motorcycle','motorbike')
        classes.append(name.replace('motorcycle','motorbike'))
>>>>>>> v2
